...
public class MatrixModel implements IMatrix<Double>, Iterable<ArrayList<Double>> {
	...
	public static MatrixModel matrixFromPoints(PuntosFigu points) {
	...
	public PuntoFig[] toPoints() {

		PuntoFig[] points = new PuntoFig[columns];

		for (int i = 0; i < columns; i++) {

			points[i] = new PuntoFig(get(0, i), get(1, i));
